...
namespace MKVmergeBatcher.src.legacy
{
    public partial class ImportLegacyForm : Form
    {
        ...
        {
            Logger.Trace(System.Reflection.MethodBase.GetCurrentMethod().Name);
            if (MainForm.windowsData.importLegacyWindow.width > 0 && MainForm.windowsData.importLegacyWindow.height > 0)
            {
        ...
        private void browseButton_Click(object sender, EventArgs e)
        {
            ...
            {
                InitialDirectory = Path.GetDirectoryName(oldUserDataTextBox.Text),
